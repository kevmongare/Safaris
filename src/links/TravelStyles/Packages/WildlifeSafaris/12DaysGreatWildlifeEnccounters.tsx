...
const Header ="12 Days Great Wildlife Enccounters"
...
const tweleveDaysGreateWildlife = () =>{
...
return(
    <>
    <div className='h-[90vh] bg-cover bg-center bg-fixed relative bg-[url("./links/TravelStyles/AdventureExpeditions/maasai-mara-wildlife.jpg")]'>
...
export default tweleveDaysGreateWildlife