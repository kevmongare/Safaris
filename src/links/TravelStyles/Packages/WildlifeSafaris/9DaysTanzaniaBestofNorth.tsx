...
const Header ="9 Days Tanzania - Best of North"
...
return(
    <>
    <div className='h-[90vh] bg-cover bg-center bg-fixed relative bg-[url("./links/TravelStyles/AdventureExpeditions/ng-crater-luxury-tanzania-safaris-1.jpg")]'>
...
export default NineDaysTanzania