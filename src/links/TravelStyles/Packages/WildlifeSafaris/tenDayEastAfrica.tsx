...
return(
    <>
    <div className='h-[90vh] bg-cover bg-center bg-fixed relative bg-[url("./links/TravelStyles/Packages/WildlifeSafaris/pictures/1d7b054b-153f-4a82-897a-94223387a17d.jpg")]'>
