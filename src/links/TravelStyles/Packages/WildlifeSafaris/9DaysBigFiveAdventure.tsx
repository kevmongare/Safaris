...
const Header ="9 Days Big Five Adventure"
...
return(
    <>
    <div className='h-[90vh] bg-cover bg-center bg-fixed relative bg-[url("./links/TravelStyles/AdventureExpeditions/samburu-national-reserve-5.jpg")]'>
...
export default nineDaysBigFive