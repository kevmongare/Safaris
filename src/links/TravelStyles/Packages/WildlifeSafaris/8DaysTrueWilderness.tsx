...
const Header ="8 Days True Wilderness"
...
return(
    <>
    <div className='h-[90vh] bg-cover bg-center bg-fixed relative bg-[url("./links/TravelStyles/AdventureExpeditions/Red-Elephants-at-Tsavo-West-National-Park-scaled.jpg")]'>
...
export default EightDaysTrueWilderness