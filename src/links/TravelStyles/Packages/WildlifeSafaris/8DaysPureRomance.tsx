...
const Header ="8 Days Pure Romance"
...
return(
    <>
    <div className='h-[90vh] bg-cover bg-center bg-fixed relative bg-[url("./links/TravelStyles/AdventureExpeditions/MeruNationalPark.jpg")]'>
...
export default eightDaysPureRomance