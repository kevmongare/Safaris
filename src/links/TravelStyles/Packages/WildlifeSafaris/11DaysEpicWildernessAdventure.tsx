...
const Header ="11 Days Epic Wilderness Adventure"
...
const ElevenDaysEpicWilderness = () =>{
...
return(
    <>
    <div className='h-[90vh] bg-cover bg-center bg-fixed relative bg-[url("./links/TravelStyles/AdventureExpeditions/mtkenya.avif")]'>
...
export default ElevenDaysEpicWilderness