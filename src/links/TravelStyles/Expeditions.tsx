...
const Intro = 'East Africa Top Wildlife Safaris'
...
const AdventureExpeditions = () =>{
  return(
    <>
    <div>
      {/* hero */}
      <div className='h-[98vh] bg-cover bg-center bg-fixed relative bg-[url("./Expeditions.jpg")]'>
...
export default AdventureExpeditions