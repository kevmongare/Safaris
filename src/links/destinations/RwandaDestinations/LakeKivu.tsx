...
const LakeKivu = () =>{
  ...
  return(
    <>
    <section>
      <div className='bg-[url("./links/destinations/RwandaDestinations/Pictures/LakeKivu.avif")] h-screen bg-fixed bg-cover text-white z-0 relative'>
       ...
       <h1 className='text-white text-7xl'>Lake Kivu</h1>
       <h2>Safari</h2>
       </div>
      </div>
