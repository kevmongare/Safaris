...
// info(text data)
const Header = 'Nyungwe Forest National Park'
...
const Nyungwe = () =>{
  ...
  return(
    <>
    <section>
      <div className='bg-[url("./links/destinations/RwandaDestinations/Pictures/Nyungwe.jpg")] h-screen bg-fixed bg-cover text-white z-0 relative'>
       ...
       <h1 className='text-white text-7xl'>Nyungwe Forest National Park</h1>
       <h2>Safari</h2>
       </div>
      </div>
