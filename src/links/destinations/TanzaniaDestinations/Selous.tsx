...
// info(text data)
const Header = 'Selous Game Reserve'
...
const Selous = () =>{
  ...
  return(
    <>
    <section>
      <div className='bg-[url("./links/destinations/TanzaniaDestinations/Pictures/Selous.jpg")] h-screen bg-fixed bg-cover text-white z-0 relative'>
       ...
       <h1 className='text-white text-7xl'>Selous Game Reserve</h1>
       <h2>Safari</h2>
       </div>
      </div>
