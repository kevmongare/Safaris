...
// info(text data)
const Header = 'Gombe Stream National Park'
...
const GombeStream = () =>{
  ...
  return(
    <>
    <section>
      <div className='bg-[url("./links/destinations/TanzaniaDestinations/Pictures/GombeStream.webp")] h-screen bg-fixed bg-cover text-white z-0 relative'>
       ...
       <h1 className='text-white text-7xl'>Gombe Stream National Park</h1>
       <h2>Safari</h2>
       </div>
      </div>
