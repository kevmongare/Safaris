...
// info(text data)
const Header = 'Tarangire National Park'
...
const Tarangire = () =>{
  ...
  return(
    <>
    <section>
      <div className='bg-[url("./links/destinations/TanzaniaDestinations/Pictures/Tarangire.webp")] h-screen bg-fixed bg-cover text-white z-0 relative'>
       ...
       <h1 className='text-white text-7xl'>Tarangire National Park</h1>
       <h2>Safari</h2>
       </div>
      </div>
