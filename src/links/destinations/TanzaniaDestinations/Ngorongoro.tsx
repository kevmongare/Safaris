...
// info(text data)
const Header = 'Serengeti National Park'
...
const Ngorongoro = () =>{
  ...
  return(
    <>
    <section>
      <div className='bg-[url("./links/destinations/TanzaniaDestinations/Pictures/Ngorongoro.jpg")] h-screen bg-fixed bg-cover text-white z-0 relative'>
       ...
       <h1 className='text-white text-7xl'>Serengeti National Park</h1>
       <h2>Safari</h2>
       </div>
      </div>
