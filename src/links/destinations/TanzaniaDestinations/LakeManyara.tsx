...
// info(text data)
const Header = 'Lake Manyara National Park'
...
const LakeManyara = () =>{
  ...
  return(
    <>
    <section>
      <div className='bg-[url("./links/destinations/TanzaniaDestinations/Pictures/Manyara.jpg")] h-screen bg-fixed bg-cover text-white z-0 relative'>
       ...
       <h1 className='text-white text-7xl'>Lake Manyara National Park</h1>
       <h2>Safari</h2>
       </div>
      </div>
