...
// info(text data)
const Header = 'Nairobi National Park'
...
const NairobiNLP = () =>{
  ...
  return(
    <>
    <section>
      <div className='bg-[url("./links/destinations/KenyanDestination/Pictures/NNLP.jpg")] h-screen bg-fixed bg-cover text-white z-0 relative'>
       ...
       <h1 className='text-white text-7xl'>Nairobi National Park</h1>
       <h2>Safari</h2>
       </div>
      </div>
