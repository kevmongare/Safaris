...
// info(text data)
const Header = 'Lake Naivasha National Park'
...
const LakeNaivasha = () =>{
  ...
  return(
    <>
    <section>
      <div className='bg-[url("./links/destinations/KenyanDestination/Pictures/LakeNaivasha.webp")] h-screen bg-fixed bg-cover text-white z-0 relative'>
       ...
       <h1 className='text-white text-7xl'>Lake Naivasha National Park</h1>
       <h2>Safari</h2>
       </div>
      </div>
