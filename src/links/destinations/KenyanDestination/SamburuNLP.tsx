...
// info(text data)
const Header = 'Samburu National Park'
...
const Samburu = () =>{
  ...
  return(
    <>
    <section>
      <div className='bg-[url("./links/destinations/KenyanDestination/Pictures/Samburu.jpg")] h-screen bg-fixed bg-cover text-white z-0 relative'>
       ...
       <h1 className='text-white text-7xl'>Samburu National Park</h1>
       <h2>Safari</h2>
       </div>
      </div>
