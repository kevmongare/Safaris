...
const Amboseli = () =>{
  ...
  return(
    <>
    <section>
      <div className='bg-[url("./links/destinations/KenyanDestination/Pictures/Amboseli.jpg")] h-[98vh] bg-fixed bg-cover text-white z-0 relative'>
       ...
       <h1 className='text-white text-7xl'>Amboseli National Park</h1>
       <h2>Safari</h2>
       </div>
      </div>
