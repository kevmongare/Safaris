...
// info(text data)
const Header = 'Meru National Park'
...
const MeruNlp = () =>{
  ...
  return(
    <>
    <section>
      <div className='bg-[url("./links/destinations/KenyanDestination/Pictures/Meru.jpg")] h-[98vh] bg-fixed bg-cover text-white z-0 relative'>
       ...
       <h1 className='text-white text-7xl'>Meru National Park</h1>
       <h2>Safari</h2>
       </div>
      </div>
