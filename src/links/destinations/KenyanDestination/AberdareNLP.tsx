...
// info(text data)
const Header = 'Aberdare National Park'
...
const Abardare = () =>{
  ...
  return(
    <>
    <section>
      <div className='bg-[url("./links/destinations/KenyanDestination/Pictures/Aberdare.jpg")] h-screen bg-fixed bg-cover text-white z-0 relative'>
       ...
       <h1 className='text-white text-7xl'>Aberdare National Park</h1>
       <h2>Safari</h2>
       </div>
      </div>
