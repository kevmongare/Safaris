...
import LakeNakuru1 from '../../../assets/Kenya/Lakenakuru/The-Wonders-of-Lake-Nakuru-National-Park--750x389.jpg'
...
// info(text data)
const Header = 'Amboseli National Park'
...
const LakeNakuru = () =>{
  ...
  return(
    <>
    <section>
      <div className='bg-[url("./links/destinations/KenyanDestination/Pictures/LakeNakuru.jpg")] h-[98vh] bg-fixed bg-cover text-white z-0 relative'>
       ...
       <h1 className='text-white text-7xl'>Lake Nakuru </h1>
       <h2>NATIONAL PARK</h2>
       </div>
      </div>
