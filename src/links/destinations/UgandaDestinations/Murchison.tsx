...
// info(text data)
const Header = 'Murchison Falls National Park'
...
const Murchison = () =>{
  ...
  return(
    <>
    <section>
      <div className='bg-[url("./links/destinations/UgandaDestinations/Pictures/Murchison.jpg")] h-screen bg-fixed bg-cover text-white z-0 relative'>
       ...
       <h1 className='text-white text-7xl'>Murchison Falls National Park</h1>
       <h2>Safari</h2>
       </div>
      </div>
