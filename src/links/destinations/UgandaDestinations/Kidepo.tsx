...
// info(text data)
const Header = 'Kidepo Valley National Park'
...
const Kidepo = () =>{
  ...
  return(
    <>
    <section>
      <div className='bg-[url("./links/destinations/UgandaDestinations/Pictures/Kidepo.webp")] h-screen bg-fixed bg-cover text-white z-0 relative'>
       ...
       <h1 className='text-white text-7xl'>Kidepo Valley National Park</h1>
       <h2>Safari</h2>
       </div>
      </div>
