...
// info(text data)
const Header = 'Queen Elizabeth National Park'
...
const Queen = () =>{
  ...
  return(
    <>
    <section>
      <div className='bg-[url("./links/destinations/UgandaDestinations/Pictures/Queen.webp")] h-screen bg-fixed bg-cover text-white z-0 relative'>
       ...
       <h1 className='text-white text-7xl'>Queen Elizabeth National Park</h1>
       <h2>Safari</h2>
       </div>
      </div>
