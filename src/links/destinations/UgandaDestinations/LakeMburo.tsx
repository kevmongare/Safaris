...
const Mburo = () =>{
  ...
  return(
    <>
    <section>
      <div className='bg-[url("./links/destinations/UgandaDestinations/Pictures/Mburo.jpg")] h-screen bg-fixed bg-cover text-white z-0 relative'>
       ...
       <h1 className='text-white text-7xl'>Lake Mburo National Park</h1>
       <h2>Safari</h2>
       </div>
      </div>
