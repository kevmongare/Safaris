...
// info(text data)
const Header = 'Mgahinga Gorilla National Park'
...
const Mgahinga = () =>{
  ...
  return(
    <>
    <section>
      <div className='bg-[url("./links/destinations/UgandaDestinations/Pictures/mgahinga.jpg")] h-screen bg-fixed bg-cover text-white z-0 relative'>
       ...
       <h1 className='text-white text-7xl'>Mgahinga Gorilla National Park</h1>
       <h2>Safari</h2>
       </div>
      </div>
