...
const Bwindi = () =>{
  ...
  return(
    <>
    <section>
      <div className='bg-[url("./links/destinations/UgandaDestinations/Pictures/bwindi.webp")] h-screen bg-fixed bg-cover text-white z-0 relative'>
       ...
       <h1 className='text-white text-7xl'>Bwindi Impenetrable Forest</h1>
       <h2>Safari</h2>
       </div>
      </div>
