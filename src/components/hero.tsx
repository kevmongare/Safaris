const Hero = () => {
  const txtMainHero = `Discover East Africa's 
    Wilderness`;
  ...
  return (
    <section 
    className="h-screen z-30 bg-[url('./assets/Main/hero.jpg')] bg-fixed bg-cover bg-center relative"
    >
      <div className=" h-screen bg-gradient-to-b from-black/90 to-transparent flex items-center justify-center pt-20">
          <div className="container mx-auto px-4 text-center text-white pt-10">
              <h1 className="whitespace-pre-line text-4xl md:text-6xl font-serif font-bold mb-6 leading-tight">
              {txtMainHero}
              </h1>
