        ...
        <div className="space-y-6">
          <div className="border-b pb-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <h4 className="text-[#3a3a2c] font-medium mb-2">Tanzania</h4>
                <ul className="space-y-1 text-sm">
              ...
              <div>
                <h4 className="text-[#3a3a2c] font-medium mb-2">Uganda</h4>
                <ul className="space-y-1 text-sm">
              ...
              <div>
                <h4 className="text-[#3a3a2c] font-medium mb-2">Rwanda</h4>
                <ul className="space-y-1 text-sm">
